...
{
  // Special case for riscv_hwprob
  long riscv_hwprobe(long a0, long a1, long a2, long a3, long a4, long a5);
  if (rvnum == 258) {
    return riscv_hwprobe(a0, a1, a2, a3, a4, a5);
  }
...
/*
 * This must come at the end because it may change some defines
 */

// From "/opt/riscv-gnu-toolchain/linux-headers/include/asm/hwprobe.h"
...
long riscv_hwprobe(long a0, long a1, long a2, long a3, long a4, long a5)
{
  ...
  for (int k=0; k<a1; ++k) {
    ...
    case RISCV_HWPROBE_KEY_IMA_EXT_0:
      p->value = RISCV_HWPROBE_IMA_FD |RISCV_HWPROBE_IMA_C;
      break;
    case RISCV_HWPROBE_KEY_CPUPERF_0:
      p->value = RISCV_HWPROBE_MISALIGNED_UNSUPPORTED;
      break;
    default:
      p->key = -1;
      p->value = 0;
